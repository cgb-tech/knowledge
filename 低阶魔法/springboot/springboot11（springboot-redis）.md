...
[Linux系统：Centos7搭建Redis单台和集群环境](http://mp.weixin.qq.com/s?__biz=MzU4Njg0MzYwNw==&mid=2247483665&idx=1&sn=c28b7fc5de72637edf3a52af94ed095d&chksm=fdf455a9ca83dcbfff502e80a84c8b162c7b48c9d06d1919ee6f1637b004d35f7d8a723dd2c9&scene=21#wechat_redirect) 
...
生产者消费者模式：客户端监听[消息队列](https://cloud.tencent.com/product/cmq?from=10680)，消息达到，消费者马上消费，如果消息队列里面没有消息，那么消费者就继续监听。基于Redis的LPUSH（BLPUSH）把消息入队，用 RPOP（BRPOP）获取消息的模式。
